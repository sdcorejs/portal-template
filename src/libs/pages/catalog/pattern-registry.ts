...
export const PAGE_PATTERNS: PagePattern[] = [
  {
    ...
    sourceFiles: [
      'src/libs/pages/components/status-badge.ts',
      ...
      'src/libs/pages/reference/page-navigation.ts',
      'src/libs/pages/components/record-header.component.ts',
    ],
    dataContract: 'src/libs/pages/data/models.ts',
    fixtures: 'src/libs/pages/data/fixture-factories.ts',
  ...
  },
  {
    ...
    sourceFiles: [
      'src/libs/pages/components/status-badge.ts',
      'src/libs/pages/data/table-query.ts',
  ...
  },
  {
    ...
    sourceFiles: [
      ...
      'src/libs/pages/reference/page-navigation.ts',
      'src/libs/pages/components/record-header.component.ts',
      'src/libs/pages/patterns/drawer-pattern-base.ts',
    ],
    dataContract: 'src/libs/pages/data/models.ts',
    fixtures: 'src/libs/pages/data/fixture-factories.ts',
    responsive: 'Hai cột chuyển một cột dưới 900px; bảng cuộn trong vùng riêng.',
