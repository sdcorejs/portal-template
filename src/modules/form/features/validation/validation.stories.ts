...
import { ValidationDemoComponent } from './validation.component';
const meta: Meta<ValidationDemoComponent> = {
...
export default meta;
export const Playground: StoryObj<ValidationDemoComponent> = {};
