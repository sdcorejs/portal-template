...
@Component({
  selector: 'app-anchor-v2-with-section',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class AnchorV2WithSectionComponent {
  pageDescription = signal(
    'Kết hợp sd-anchor-v2 với sd-section để tạo giao diện chuyên nghiệp cho các trang tài liệu, hướng dẫn, hoặc FAQ.'
  );
  ...
  <sd-anchor-v2 
    ...
    <sd-anchor-item-v2 [title]="'Giới thiệu sản phẩm'" [icon]="'info'">
    ...
    <sd-anchor-item-v2 [title]="'Hướng dẫn cài đặt'" [icon]="'download'">
    ...
    <sd-anchor-item-v2 [title]="'Tính năng nâng cao'" [icon]="'star'">
    ...
    <sd-anchor-item-v2 [title]="'FAQ & Hỗ trợ'" [icon]="'help'">
...
@Component({
  ...
  standalone: true,
  imports: [SdAnchorV2, SdAnchorItemV2, SdSection, SdSectionItem],
  template: \`
    <div style="height: 700px">
      <sd-anchor-v2 [sidebarWidth]="'220px'">
        
        <sd-anchor-item-v2 [title]="'Giới thiệu'" [icon]="'info'">
        ...
        <sd-anchor-item-v2 [title]="'Hướng dẫn'" [icon]="'book'">
