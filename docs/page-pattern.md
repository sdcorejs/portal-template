...
- Route: /page/list/roles-matrix
- Create: /page/list/roles-matrix/create
- Detail: /page/list/roles-matrix/:id/detail
- Update: /page/list/roles-matrix/:id/update
...
- Route: /page/list/roles-tree
- Create: /page/list/roles-tree/create
- Detail: /page/list/roles-tree/:id/detail
- Update: /page/list/roles-tree/:id/update
...
- Route: /page/list/list-standard
- Create: /page/list/list-standard/create
- Detail: /page/list/list-standard/:id/detail
- Update: /page/list/list-standard/:id/update
...
- Route: /page/list/list-advanced-filter
- Create: /page/list/list-advanced-filter/create
- Detail: /page/list/list-advanced-filter/:id/detail
- Update: /page/list/list-advanced-filter/:id/update
...
- Route: /page/list/list-grouped-tree
- Create: /page/list/list-grouped-tree/create
- Detail: /page/list/list-grouped-tree/:id/detail
- Update: /page/list/list-grouped-tree/:id/update
...
- Route: /page/list/list-master-detail
- Create: /page/list/list-master-detail/create
- Detail: /page/list/list-master-detail/:id/detail
- Update: /page/list/list-master-detail/:id/update
...
- Shape: flat; container: page
- Route: /page/detail/detail-overview
- Create: /page/detail/detail-overview/create
- Detail: /page/detail/detail-overview/:id/detail
- Update: /page/detail/detail-overview/:id/update
...
- Route: /page/detail/detail-tabbed
- Create: /page/detail/detail-tabbed/create
- Detail: /page/detail/detail-tabbed/:id/detail
- Update: /page/detail/detail-tabbed/:id/update
...
- Route: /page/detail/detail-related-records
- Create: /page/detail/detail-related-records/create
- Detail: /page/detail/detail-related-records/:id/detail
- Update: /page/detail/detail-related-records/:id/update
...
- Shape: flat; container: page
- Route: /page/detail/form-simple
- Create: /page/detail/form-simple/create
- Detail: /page/detail/form-simple/:id/detail
- Update: /page/detail/form-simple/:id/update
...
- Route: /page/detail/form-sections
- Create: /page/detail/form-sections/create
- Detail: /page/detail/form-sections/:id/detail
- Update: /page/detail/form-sections/:id/update
...
- Shape: parent-lines; container: page
- Route: /page/detail/form-line-items
- Create: /page/detail/form-line-items/create
- Detail: /page/detail/form-line-items/:id/detail
- Update: /page/detail/form-line-items/:id/update
...
- Route: /page/detail/drawer-compact
- Create: /page/detail/drawer-compact/create
- Detail: /page/detail/drawer-compact/:id/detail
- Update: /page/detail/drawer-compact/:id/update
...
- Route: /page/detail/drawer-sections
- Create: /page/detail/drawer-sections/create
- Detail: /page/detail/drawer-sections/:id/detail
- Update: /page/detail/drawer-sections/:id/update
