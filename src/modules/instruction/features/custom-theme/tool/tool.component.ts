...
@include mat.all-component-themes($custom-theme);`;
  ...
  // ── Palette math ─────────────────────────────────────────────────────────────
  private shade(palette: [string, string][], stop: string): string {
...
SdTabComponent({ component: CustomThemeToolComponent, name: 'Công cụ sinh Theme cho Portal', icon: 'menu_book' })(CustomThemeToolComponent);
