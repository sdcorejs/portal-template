...
| Score card | `/patterns/scores` | Metric chỉ đọc; icon cạnh nhãn; icon trong nền màu; icon trạng thái; icon + click-filter; count để filter; progress; so sánh hai kỳ; compact |
