...
export class AnchorWithSectionComponent {
  pageDescription = signal('Kết hợp sd-anchor với sd-section để tạo giao diện chuyên nghiệp cho các trang tài liệu, hướng dẫn, hoặc FAQ.');
  ...
  <sd-anchor 
    ...
    <sd-anchor-item [title]="'Giới thiệu sản phẩm'" [icon]="'info'">
      <sd-section title="Giới thiệu sản phẩm" icon="info" subTitle="Tìm hiểu thêm về sản phẩm của chúng tôi">
    ...
    <sd-anchor-item [title]="'Hướng dẫn cài đặt'" [icon]="'download'">
      <sd-section title="Hướng dẫn cài đặt" icon="download" subTitle="Các bước cài đặt từng bước">
    ...
    <sd-anchor-item [title]="'Tính năng nâng cao'" [icon]="'star'">
      <sd-section title="Tính năng nâng cao" icon="star">
    ...
    <sd-anchor-item [title]="'FAQ & Hỗ trợ'" [icon]="'help'">
      <sd-section title="FAQ & Hỗ trợ" icon="help">
...
SdTabComponent({ component: AnchorWithSectionComponent, name: 'Với sd-section', icon: 'widgets' })(AnchorWithSectionComponent);
